class Game {
  ...
  #runAnimationMove = () => {
    ...
    this.#onMoveTween(this.rect2, -500, 1)
      .onComplete.add(() => this.#report(this.rect2))
    
    this.#onMoveTween(this.rect3, -500, 2)
          .onComplete.add(() => this.#report(this.rect3))
    
    this.#onMoveTween(this.rect4, -500, 3)
          .onComplete.add(() => this.#report(this.rect4))
    
    this.#onMoveTween(this.rect5, -500, 4)
  ...
  #createText = () => {
    ...
    bar.beginFill(0xC0C0C0, 0.5);
    bar.drawRect(0, 800, this.game.width, 100);
